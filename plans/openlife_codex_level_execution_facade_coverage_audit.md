...
Status: Codex-level coverage audit / Scheduled-Proactive event validation hardened

Scope: code-fact audit plus Scheduled / Proactive event creation validation and scheduler outcome hardening. Builder, Calibration, and Skill runtime paths remain unmigrated.
