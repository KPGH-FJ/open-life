...
| 3 LifeModel Closed Loop | `plans/sprint3_lifemodel_closed_loop_solution_rfc.md` | Ready for Slice 3A implementation | Yes | Open questions are frozen; first slice is limited to `preferences.communication_style` accepted-write visibility with canonical path/source/proposal/patch/current-view trace. |
