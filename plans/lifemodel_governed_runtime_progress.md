...
W1-W53 are complete. The project now has a governed PlanExecute V1 vertical
...
binds send/stream entries to their legacy route path and contract shape. Default
