...
3. [`plans/lifemodel_governed_runtime_progress.md`](plans/lifemodel_governed_runtime_progress.md)：W1-W35 完成度与当前 non-default preview / migration gate / pilot eligibility / controlled pilot / reviewed promotion / source-bound validation / promotion evidence / promotion readiness / reviewed migration plan draft / manual review decision evidence / implementation gate / shadow run / shadow review evidence / cutover planning readiness / cutover candidate adapter / cutover candidate review evidence / candidate promotion readiness / default Chat runtime boundary / activation plan draft 状态索引；不是第二套路线图。
