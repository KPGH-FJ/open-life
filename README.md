...
- **当前阶段是 Main Chat Agent Execution v1 整改中，不是 complete**：W124-W149 LifeModel-Governed Backend Completion Goals 1-8、W150-W158 Skill Runtime Beta Maturity 已完成；普通 `send_message` / `start_stream_message` 已接入 AgentIngress 和 governed task session/transcript/action queue。DirectAnswer deterministic reflex path 现在也会记录 Main Chat strategy AgentRun、prompt/context transcript 并完成 task session；ReActToolExecution 现在会先尝试带 governed plan guidance 的 AgentLoop，再 fail-soft 到 single-step ActionExecutor-backed read action path，保留 governed follow-up synthesis、direct read parser/executor input 对齐、eval-gated memory/session multi-step AgentLoop read/observe/follow-up proof、web network-policy blocker AgentLoop proof、fixture-backed successful web read AgentLoop proof、registered MCP AgentLoop success proof、registered MCP ToolPermission proposal runtime proof，以及命名 read-only MCP manifest resolution。
...
- **当前 Goal-mode 入口是 Main Chat Agent Execution v1**：下一步优先完成真实 runtime/harness eval、multi-step ReAct governed tool loop、web/MCP manifest/permission cases 的更完整覆盖，以及更广 provider/live proposal-permission 验收；之后再进入更多 PlanExecute 场景、provider executor 接入或 Beta 发布门控。
...
2. [Main Chat Agent Migration v1 Goal Spec](/Users/fujing/Desktop/偶来福/plans/main_chat_agent_migration_v1_goal_spec.md)
3. [OpenLife LifeModel-Governed Agent Runtime Program](/Users/fujing/Desktop/偶来福/plans/openlife_lifemodel_governed_agent_runtime.md)
4. [LifeModel-Governed Runtime Progress](/Users/fujing/Desktop/偶来福/plans/lifemodel_governed_runtime_progress.md)
5. [OpenLife Agent Framework Architecture](/Users/fujing/Desktop/偶来福/plans/openlife_agent_framework_architecture.md)
6. [OpenLife ReAct Beta Roadmap](/Users/fujing/Desktop/偶来福/plans/openlife_react_beta_roadmap.md)
7. [LifeModel-HS MVP Task Specifications](/Users/fujing/Desktop/偶来福/plans/lifemodel_hs_mvp_task_specs.md)
8. [ADR 0013: LifeModel-HS Source Of Truth And Governance](/Users/fujing/Desktop/偶来福/plans/adr/0013-lifemodel-hs-source-of-truth-governance.md)
9. [LifeModel-HS Legacy Write Path Audit](/Users/fujing/Desktop/偶来福/plans/lifemodel_hs_legacy_write_path_audit.md)
10. [LifeModel-HS Architecture Plan](/Users/fujing/Desktop/偶来福/plans/lifemodel_hs_architecture_plan.md)
11. [OpenLife PRD v2: Personal Agent Framework](/Users/fujing/Desktop/偶来福/OpenLife_PRD_v2_Agent_Framework.md)
12. [OpenLife Development Plan](/Users/fujing/Desktop/偶来福/plans/openlife_development_plan.md)
13. [Codex Execution Playbook](/Users/fujing/Desktop/偶来福/plans/openlife_codex_execution_playbook.md)
14. [OpenLife Final PRD](/Users/fujing/Desktop/偶来福/OpenLife_Final_PRD.md)，仅作为历史需求参考
