...
import { cloneSettingsConfig } from "@/ui/journeys/settingsPrivacy";
import type { Phase4dFixtureId } from "./phase4d-fixtures";
...
function configForFixture(id: Phase4dFixtureId): AppConfig {
  const external = [
...
export function createPhase4dSettingsFixture(id: Phase4dFixtureId): {
  dataSource: SettingsPrivacyDataSource;
