...
function todayInput(id: Phase4dFixtureId): BuildTodayViewModelEnvelopeInput {
  if (id === "fixture-error") {
    return {
      projection: null,
      status: "error",
...
function makeTodaySnapshot(id: Phase4dFixtureId): TodayReadOnlySnapshot {
...
function makeTasksSnapshot(id: Phase4dFixtureId): TasksReadOnlySnapshot {
  const status =
    id === "fixture-error"
      ? "error"
      : id === "fixture-stale"
