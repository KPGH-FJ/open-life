    ...
    vi.mocked(invoke).mockImplementation((cmd: string, args?: Record<string, any>) => {
      if (cmd === "get_system_diagnostics") {
        return Promise.resolve({
          ...
          chat_ready: true,
          readiness_issues: [
            "应用数据目录创建失败：/Users/alice/Library/Application Support/ai.openlife.desktop (permission denied)",
          ...
          data_dir: "/Users/alice/Library/Application Support/ai.openlife.desktop",
          active_data_dir: "/Users/alice/Library/Application Support/ai.openlife.desktop",
          legacy_data_dir: null,
          database_status: "ok",
          snapshot_count: 3,
          life_model_ready: true,
