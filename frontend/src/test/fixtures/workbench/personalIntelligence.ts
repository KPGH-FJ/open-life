...
import type { PersonalIntelligenceSnapshot } from "@/features/personalIntelligence/personalIntelligenceDataSource";
...
const providerBoundaryEvidence: EvidenceRef = {
  id: "provider-route:fixture-local",
  label: "Fixture local provider route",
  source: "provider",
  sensitivity: "local_private",
};

const providerBoundary: ProviderPrivacyBoundarySummary = {
  routeType: "local",
  ...
  evidenceRefs: [providerBoundaryEvidence],
};
...
export function initialDurableFixtureStage(id: WorkbenchFixtureId): DurableFixtureStage {
  if (id === "fixture-personal-intelligence-approved") return "approved_not_applied";
  if (id === "fixture-personal-intelligence-applying") return "applying";
  if (id === "fixture-personal-intelligence-applied") return "applied";
  if (id === "fixture-personal-intelligence-failed") return "failed";
  if (id === "fixture-personal-intelligence-rolled-back") return "rolled_back";
  return "pending";
}

export function buildPersonalIntelligenceFixtureSnapshot(
  ...
  return {
    ...
    boundaryEnvelope: envelope(providerBoundary, status, "ProviderPrivacyBoundarySummary", [
