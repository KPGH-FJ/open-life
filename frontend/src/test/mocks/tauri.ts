...
export const mockAgentRunEvents: AgentRunEvent[] = [
  ...
  },
  {
    ...
    payload: {
      promptBlocks: [
        { id: "base_system", version: "1.0.0", purpose: "base_system" },
        { id: "tool_discipline", version: "1.0.0", purpose: "tool" },
        { id: "privacy_rule", version: "1.0.0", purpose: "privacy" },
      ],
    },
    createdAt: "2026-05-06T10:00:01.1Z",
  },
  {
    id: "evt-contextgovernance-001",
    runId: "run-001",
    eventType: "context_governance.applied",
    actor: "runtime",
    summary: "Context governance applied",
    payload: {
      contextIncluded: ["life_model_summary", "goals", "state"],
      contextExcluded: [],
    },
    createdAt: "2026-05-06T10:00:01.2Z",
  },
  {
  ...
  {
    id: "evt-model-failed-001",
    runId: "run-001",
    eventType: "model.failed",
    actor: "runtime",
    summary: "Model call failed: LocalOnly privacy blocked cloud fallback",
    payload: { error: "LocalOnly privacy policy requires a local model", recoverable: false },
    createdAt: "2026-05-06T10:00:02.5Z",
  },
  {
  ...
  },
  {
    ...
    payload: {
      ...
      redacted_fields: ["pii_detected", "life_model", "sensitive_user_text"],
  ...
  },
  {
    ...
    payload: {
      compaction_id: "c1",
      run_id: "run-001",
      reason: "message count 25 >= threshold 20",
      original_token_estimate: 4500,
      compacted_token_estimate: 600,
      source_message_count: 25,
      active_proposal_count: 2,
