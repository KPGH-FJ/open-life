...
import type { WorkbenchSnapshot } from "@/app/workbenchDataSource";
import { workspaceContext } from "@/app/workbenchPresentation";
...
function snapshot(status: ViewModelEnvelope<unknown>["status"] = "ready"): WorkbenchSnapshot {
  return {
