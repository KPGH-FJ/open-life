...
pub(crate) fn legacy_write_convergence_inventory() -> Vec<LegacyWriteInventoryEntry> {
    vec![
        ...
        entry(
            ...
            false,
            "Finished Builder sessions with pending signals create ProposalStore entries and do not directly mutate LifeModel truth.",
        ...
        entry(
            ...
            LegacyWriteSafeModeStatus::ProposalFirstGuardPresent,
            false,
            "Calibration proposal mode assesses risk and creates Review Center proposals instead of durable direct writes.",
            "Keep proposal mode as the product default and convergence target.",
        ...
        entry(
            ...
            LegacyWriteSafeModeStatus::GuardRequired,
            true,
            "Explicit direct calibration and micro-evolution can persist high-risk LifeModel dimensions outside proposal review.",
            "Gate direct calibration/evolution as legacy debug or convert all product writes into proposals.",
            "W81 Calibration direct/evolution proposal-first convergence.",
            &[
                "direct_calibration_mode_can_persist_durable_lifemodel_truth",
                "micro_evolution_can_apply_generated_changes_directly",
            ],
        ),
        entry(
            ...
            &["apply_feedback_evolution", "generate_evolution_report"],
            LegacyWriteRiskClass::HighRiskLegacyDirectWrite,
            LegacyWriteConvergenceStatus::LegacyDirectWriteBlocker,
            false,
            true,
            ...
            LegacyWriteSafeModeStatus::GuardRequired,
            true,
            "Feedback evolution command paths can write model changes through the central save primitive after analytics/evolution suggestions.",
            "Convert feedback-driven model changes into EvidenceStore records plus heuristic or LifeModel proposals.",
            "W82 Feedback evolution proposal/evidence convergence.",
            &[
                "feedback_evolution_can_write_durable_lifemodel_truth",
