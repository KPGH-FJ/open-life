...
pub(crate) fn legacy_write_convergence_inventory() -> Vec<LegacyWriteInventoryEntry> {
    vec![
        ...
        entry(
            ...
            LegacyWriteSafeModeStatus::ProposalFirstGuardPresent,
            false,
            "calibration_create_proposals and apply_calibration(mode!=direct) assess risk and create Mailbox proposals instead of durable direct writes.",
        ...
        entry(
            ...
            LegacyWriteSafeModeStatus::ProposalFirstGuardPresent,
            false,
            "Mailbox apply/edit is the governed convergence target; high-risk durable writes occur only after accepted proposal review; W95 resolves every ProposalSource to a source-specific PatchSource with no misleading fallback.",
