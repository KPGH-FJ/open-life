...
use commands::agent_runtime::{
    ...
    check_default_chat_adapter_implementation_readiness, check_runtime_migration_gate,
    ...
    get_default_chat_adapter_dry_run_review_summary, get_default_chat_adapter_routing_status,
