...
fn runtime_seed_objects() -> BTreeMap<&'static str, serde_json::Value> {
    BTreeMap::from([
        ...
        (
            "failed_read_action",
            serde_json::json!({"kind":"action","status":"failed","retryScope":"file.read:dogfood/planning_notes.md"}),
        ),
        (
            "non_terminal_task",
...
fn stage1_scenarios() -> Vec<Stage1ScenarioDef> {
    vec![
        ...
        d("D02", "P0", "chat_e2e", "Read file `dogfood/project_brief.md` as a governed workspace file observation and summarize it.", "read_action:file.read", &["action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "dogfood/project_brief.md"),
        ...
        d("D04", "P0", "chat_e2e", "Use my current memory/preferences when answering how I should choose tomorrow's first focus.", "DirectAnswer:memory_context", &["answering", "completed"], &["completed_work", "observations_used"], "success", None, "accepted_memory"),
        ...
        d("D06", "P0", "chat_e2e", "Use the selected review skill to critique this weekly plan.", "selected_skill_context", &["planning", "completed"], &["completed_work", "observations_used"], "success", None, "selected_skill + dogfood/planning_notes.md"),
        ...
        d("D08", "P0", "chat_e2e", "Draft a weekly plan and break this goal into steps.", "Plan-Execute", &["planning", "action_running", "observation_ready", "completed"], &["completed_work", "observations_used", "next_action"], "success", None, "dogfood/planning_notes.md"),
        ...
        d("D16", "P0", "chat_e2e", "Publish the seeded `dogfood/policy_note.md` to a sensitive external destination named in the write-like action seed.", "permission_blocker", &["permission_needed", "blocked"], &["blocked_work", "pending_user_action"], "expected_blocker", Some("permission_required"), "write_like_action"),
        ...
        d("D21", "P0", "chat_e2e", "Compare two memory facts that conflict.", "memory_conflict", &["completed"], &["completed_work", "observations_used"], "success", None, "conflicting_memory_pair"),
        d("D22", "P0", "chat_e2e", "Ask a task that needs multiple reads.", "multi_read_ReAct", &["planning", "action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "dogfood/project_brief.md + memory/session seed"),
        d("D23", "P0", "chat_e2e", "Fetch http://127.0.0.1/stage1-dogfood-network-policy while network policy blocks private addresses.", "web_blocker", &["blocked"], &["blocked_work", "next_action"], "expected_blocker", Some("web_network_policy_blocked"), "network_private_address_policy"),
        d("D24", "P0", "chat_e2e", "Use MCP missing_manifest_tool read-only when no manifest exists.", "MCP_blocker", &["blocked"], &["blocked_work", "next_action"], "expected_blocker", Some("mcp_missing_read_target"), "missing_mcp_target"),
        ...
        d("D29", "P1", "chat_e2e", "Ask a simple personal focus question with no required tool.", "DirectAnswer", &["answering", "completed"], &["completed_work"], "success", None, "none"),
        d("D30", "P1", "chat_e2e", "Read file `dogfood/planning_notes.md` and create a memory proposal if useful.", "read_plus_proposal", &["action_running", "observation_ready", "memory_candidate", "completed"], &["completed_work", "proposals_created", "pending_user_action"], "proposal", None, "dogfood/planning_notes.md"),
        d("D31", "P1", "chat_e2e", "Plan the seeded policy-note publication task, but ask me before any risky external publish step.", "Plan-Execute_blocker", &["planning", "permission_needed", "blocked"], &["blocked_work", "pending_user_action"], "expected_blocker", Some("permission_required"), "dogfood/planning_notes.md + write_like_action"),
        d("D32", "P1", "chat_e2e", "Use the selected skill plus a file read of `dogfood/planning_notes.md` to review the seed plan.", "skill_plus_file_read", &["planning", "action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "selected_skill + dogfood/planning_notes.md"),
        d("D33", "P1", "chat_e2e", "Find what we discussed about prior session context, then answer using current memory.", "session_plus_memory", &["action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "seeded_chat_session + accepted_memory"),
        d("D34", "P1", "chat_e2e", "Propose an edit to SOUL.md knowledge asset wording.", "knowledge_proposal", &["memory_candidate", "permission_needed"], &["proposals_created", "pending_user_action"], "proposal", None, "SOUL.md"),
