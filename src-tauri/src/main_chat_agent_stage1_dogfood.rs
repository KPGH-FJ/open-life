...
fn stage1_scenarios() -> Vec<Stage1ScenarioDef> {
    vec![
        ...
        d("D02", "P0", "chat_e2e", "Summarize `dogfood/project_brief.md`.", "read_action:file.read", &["action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "dogfood/project_brief.md"),
        ...
        d("D16", "P0", "chat_e2e", "Publish the seeded `dogfood/policy_note.md` to the external destination named in the write-like action seed.", "permission_blocker", &["permission_needed", "blocked"], &["blocked_work", "pending_user_action"], "expected_blocker", Some("permission_required"), "write_like_action"),
        ...
        d("D22", "P0", "chat_e2e", "Answer using two different read sources.", "multi_read_ReAct", &["planning", "action_running", "observation_ready", "completed"], &["completed_work", "observations_used"], "success", None, "dogfood/project_brief.md + memory/session seed"),
        ...
        d("D30", "P1", "chat_e2e", "Summarize a seeded note and create a memory proposal if useful.", "read_plus_proposal", &["action_running", "observation_ready", "memory_candidate", "completed"], &["completed_work", "proposals_created", "pending_user_action"], "proposal", None, "dogfood/planning_notes.md"),
