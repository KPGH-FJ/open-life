...
| Future account/drawer advanced access | ProductShell advanced groups and same-level advanced routes | ProductShell secondary/advanced navigation | Shell V2 puts Settings and Advanced outside mobile primary nav; unavailable states are explicit | Navigation matrix and release route inventory | `identified` |
