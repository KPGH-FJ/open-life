...
fn frontend_parity_manifest() -> Vec<FrontendTypedEventContractEntry> {
    vec![
        ...
        FrontendTypedEventContractEntry::new(
            ...
            "fallback.started",
            &["status", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary"],
            &["prompt_stack_source"],
            &["fallback.started"],
            &["fallback.started", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary"],
            &[],
            true,
        ),
        FrontendTypedEventContractEntry::new(
            ...
            "fallback.completed",
            &["status", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary", "response_length"],
            &["prompt_stack_source"],
            &["fallback.completed"],
            &["fallback.completed", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary", "response_length"],
            &[],
            true,
        ),
        FrontendTypedEventContractEntry::new(
            ...
            "fallback.failed",
            &["status", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary", "fallback_error_summary"],
            &["prompt_stack_source"],
            &["fallback.failed"],
            &["fallback.failed", "fallback_mode", "generation_path", "agent_spec_id", "privacy_policy", "original_error_summary", "fallback_error_summary"],
            &[],
            true,
        ),
        FrontendTypedEventContractEntry::new(
